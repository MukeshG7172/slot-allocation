        ...
        <div className="bg-gray-800 border border-gray-700 rounded-lg p-8 shadow-2xl transform transition-all hover:shadow-indigo-500/10">
          ...
          <div className="flex flex-col items-center justify-center space-y-6">
            <button
              ...
              className="flex items-center justify-center w-full py-2 px-4 bg-white hover:bg-gray-100 text-gray-800 font-medium rounded-md transition duration-200 shadow-md"
            >
